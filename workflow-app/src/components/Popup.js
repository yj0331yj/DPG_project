...
import { Search, FileSpreadsheet, Mail, MessageSquare, Brain, Calendar, Cloud, Database, FileText, Trello, GitBranch, Twitter, Linkedin, Facebook, Instagram } from 'lucide-react';

const AppItem = ({ icon, name, count, color, onSelect }) => (
  <div className="flex items-center p-2 hover:bg-gray-100 cursor-pointer" onClick={() => onSelect({ icon, color })}>
...
const Popup = ({ onClose, isExpanded, onSelectIcon }) => {
  ...
  return (
    <>
      ...
      >
        <div 
          className={`bg-white rounded-lg shadow-lg w-96 max-h-[80vh] flex flex-col transition-all duration-300 ease-in-out ${
        ...
        >
          <div className="p-6 flex-1 overflow-y-auto">
            ...
            <div className="space-y-2">
              ...
              <AppItem icon={<Twitter size={24} />} name="Twitter" count={3} color="#1DA1F2" onSelect={handleSelectIcon} />
